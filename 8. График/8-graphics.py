...
#читаем показания компаратора и переводим через шаг квантования в вольты
data=numpy.loadtxt('data.txt', dtype=int) * settings[1]

#массив из времен, создаваемый через количество измерений и известный шаг по времени
...
#название графика с условием переноса строки и центровкой
